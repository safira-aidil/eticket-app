<x-guest-layout>
    ...
    <style>
        ...
        .ultra-card {
            ...
            width: 100%;
            height: 750px; /* Sedikit lebih tinggi untuk menampung input daftar */
            background: white;
            border-radius: 30px;
            overflow: hidden;
        ...
        /* 3. Sisi Kiri (Branding) - Konsisten dengan Login */
        .side-branding {
            background: #002455;
            padding: 60px;
            color: white;
        ...
        .form-title { font-size: 2.4rem; font-weight: 800; color: #001a3d; margin-bottom: 5px; }
    ...
    <div class="ultra-card">
        <div class="side-branding">
            ...
            <div class="title-area">
                ...
                <p class="desc-area">Buat akun untuk mulai mengelola permintaan layanan bantuan Anda.</p>
            </div>
        ...
        <div class="side-login">
            ...
            <p style="color: #64748b; margin-bottom: 25px;">Lengkapi data di bawah untuk mendaftar ke portal.</p>
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="name" class="custom-input" placeholder="Masukkan nama lengkap" value="{{ old('name') }}" required autofocus autocomplete="name">
                </div>

                <div class="input-group">
                    <label>Alamat Email</label>
                    <input type="email" name="email" class="custom-input" placeholder="email@binjaikota.go.id" value="{{ old('email') }}" required autocomplete="username">
                </div>

                <div class="input-group">
                    <label>Kata Sandi</label>
                    <input type="password" name="password" class="custom-input" placeholder="••••••••" required autocomplete="new-password">
                </div>

                <div class="input-group">
                    <label>Konfirmasi Kata Sandi</label>
                    <input type="password" name="password_confirmation" class="custom-input" placeholder="••••••••" required autocomplete="new-password">
                </div>

                <button type="submit" class="btn-portal">Daftar Akun →</button>
            </form>

            <p style="text-align: center; margin-top: 30px; color: #64748b; font-size: 0.9rem;">
                Sudah punya akun? <a href="{{ route('login') }}" style="color: #ff6b35; font-weight: 800; text-decoration: none;">Masuk Sekarang</a>
            </p>
        </div>
    </div>
</x-guest-layout>